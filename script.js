...
function updateCounterList() {
    ...
    counters.forEach((counter, index) => {
        ...
        <button class=" text-red-500 px-6 border-l border-stone-700" onclick="deleteCounter(${index})" aria-label="Delete Counter"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
